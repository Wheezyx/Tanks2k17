...
namespace ProjektGry
{
    public partial class Form1 : Form
    {
        ...
        public Form1(string NickP1, bool Player2ActiveInGame, string NickP2, int MapNumber, ushort Tank1Color, ushort Tank2Color, int GameModeOption, bool FriendlyFireOption, int DifficultyLevel, int GameMusic, int Volume)
        {
            #region Add_Bullets
